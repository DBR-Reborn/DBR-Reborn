...
void skill_func(object from, object at, string arg) {
    ...
    string shieldstr;
    object shieldob;
    int acid, spiked, oiled, royal, acidnew;
    ...
    royal=shieldob->query_property("royalins");
	...
	if((royal*10 > at->query_skill("dodge")) && royal){
	    do_critical(from, at, "royal A");
	}
