...
set_up(int pow, string *ele, string name) {
  ...
  power = pow;
  set_level(13+pow/2);
 set_short("["+this_object()->query_level()+"] greater "+name+" elemental");
  set_exp(100000);
  ...
  set_skill("body block", (this_object()->query_level()) * 4);
  set_skill("elementalism", (this_object()->query_level()) * 4);
  set_skill(element+" lore", (this_object()->query_level()) * 4);
/*
