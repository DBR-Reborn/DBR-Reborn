...
void create() {
    ...
    set_long("This is a perfectly spherical glowing orb approximately nine inches in diameter. it appears like nothing but maybe if you did the commad%^YELLOW%^'orb bfury'%^RESET%^somthing might happen\n");
    set_weight(10);
    set_value(1);
...
int fun_orb(string mesg) {
   ...
   if(!mesg) {
     ...
     if(mesg != "bfury" && mesg != "Bfury" && mesg != "bf") {
