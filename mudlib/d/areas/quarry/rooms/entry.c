...
inherit "std/room";
#define ENTRY "d/areas/quarry/rooms/01"
...
if (!present("sentry")) 
	...
	while(i--)
	{
new("d/areas/quarry/mon/sentry.c")->move(this_object());
new("d/areas/quarry/mon/shieldbreaker.c")->move(this_object());
	    new("d/areas/quarry/mon/youngslayer")->move(this_object());
	    new("d/areas/quarry/mon/worker")->move(this_object());
        new("d/areas/quarry/mon/dwarfslayer")->move(this_object());
	}
  }
}
